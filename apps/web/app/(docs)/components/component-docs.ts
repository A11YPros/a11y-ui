...
export const componentDocs: ComponentDocMeta[] = [
  ...
  },
  {
    slug: 'menu',
    title: 'Menu',
    summary: 'Accessible dropdown action menu with roving focus navigation.',
    storybookPath: '/storybook-static/index.html?path=/docs/components-menu--docs',
  },
  {
    slug: 'menubar',
    title: 'Menubar',
    summary: 'Desktop-style application menu bar consuming composed menus.',
    storybookPath: '/storybook-static/index.html?path=/docs/components-menubar--docs',
  },
  {
    slug: 'modal',
    title: 'Modal',
